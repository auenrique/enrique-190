...
def get_emotion_features (data, lex):
    ...
    raw_scores = data['tokenized'].apply(lambda x: build_raw_score(x, lex))
    ...
    avg_emotion_scores = data['tokenized'].apply(lambda x: get_avg_emotion(x, lex))
    ...
    pct_emotion_scores = data['tokenized'].apply(lambda x: get_pct_emotion(x, lex))
